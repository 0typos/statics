...
/*
 * Linux 7.1 pidfd UAPI adapted for Zig's musl headers.  The upstream header
 * includes <linux/fcntl.h>, which conflicts with musl's <fcntl.h>; using the
 * libc header provides the same O_* values without redefining struct flock.
 */
